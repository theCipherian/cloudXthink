  ...
  <div id='text_3432299'>Changes saved</div>
    ...
    <!-- SIDE PARTS -->
     <div class='sidepart '>
         ...
         <div class='sidepart_items' style='overflow:hidden' id='get_data_3432'>
        <form class='department_add'>
        <input type="text" id='email' placeholder='Email address'>
        <input type="text" id='password' placeholder='Password'>
        <div class='button ' id='data_verify'>Done  </div>
        <a style='text-decoration:none;color:unset' href='cloudcat_passage.php'> <div class='in_text'>- I'M AN ADMINISTRATOR -</div></a>
        </form>  
...
$(document).ready(function(){
    $("#data_verify").click(function(){
        ...
        if(email.value.length < 1 || password.value.length < 1){
            show_pop_wrong("Whoooosh! Fill all fields");
        }else{
            $.ajax({
                url:"cloudcat_parser.php",
                type:"POST",
                async:false,
                data:{
                    "email_verify":email.value,
                    "password_verify":password.value
                    ...
                    if(data == 'yup'){
                        ...
                        show_pop_wrong("Invalid data");
                    }else if(data == ''){
                        show_pop_wrong("Some error occured, please try again");
                    }
                }
            })
        }
