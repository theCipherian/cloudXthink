...
$query = mysqli_query($init, "SELECT unique_id, first_name, middle_name, last_name, student_email FROM students_ WHERE registration_number = 'NOT ASSIGNED' ORDER BY id DESC LIMIT {$limit} OFFSET {$offset}");
