...
if(isset($_SESSION['cloudcat_data'])){
  ?>
<script>
    window.location.href = 'control_room.php'
</script>
  <?php
}
?>
  ...
  <div id='text_3432299'>Changes saved</div>
    ...
    <!-- SIDE PARTS -->
     <div class='sidepart '>
        ...
        <a style='text-decoration:none;color:unset' href='cloudcat_passage1.php'> <div class='in_text'>- I'M A STUDENT -</div></a>
        </form>  
        <div>
