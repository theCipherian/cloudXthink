...
if(isset($_POST['sdd'])){
$dep_data = $_POST['sdd'];
$query = mysqli_query($init, "SELECT * FROM data_points_department WHERE unique_id = '$dep_data'");
    ...
    $(".greencard").unbind("click").click(function(){
      $.ajax({
          ...
          data:{
              ...
              $(".view_data_9").load("show_data_department.php");
          }
      })
   })
...
<?php
 if(isset($_POST['del_sdd'])){
     $del = $_POST['del_sdd'];
     $query = mysqli_query($init, "DELETE FROM data_points_department WHERE unique_id = '$del'");
 }
 if(isset($_POST['data_1'], $_POST['data_2'])){
     $data1 = $_POST['data_1'];
     $data2 = $_POST['data_2'];
     $query = mysqli_query($init, "UPDATE data_points_department SET department_name = '$data2' WHERE unique_id = '$data1'");
 }
?>